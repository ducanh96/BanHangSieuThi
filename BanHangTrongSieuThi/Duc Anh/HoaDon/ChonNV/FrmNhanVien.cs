...
namespace BanHangTrongSieuThi.Duc_Anh.HoaDon.ChonNV
{
    public partial class FrmNhanVien : Form
    {
        ...
        public FrmCreateHoaDon _frmCreateDH;
        public FrmNhanVien()
        {
            InitializeComponent();
        ...
        {
            var NhanVienChon = dgvNhanVien.CurrentRow.DataBoundItem as NhanVien;


            _frmCreateDH.txtMaNV.Text = NhanVienChon.MaNV.ToString();
            _frmCreateDH.txtTenNV.Text = NhanVienChon.TenNV;
            this.Close();
